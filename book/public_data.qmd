...
The following list contains a set of data sources to kick-start your projects. Some of these datasets are very general and will be used for multiple applications, while others contain more niche data that may spark ideas for a course project. Read through them all to take inspiration for your data analysis. Of course, there are a thousand other datasets out there!

::: callout-note
Although all of the following datasets are publicly available, a fraction of these will require you to create an account in the data provider's website and log in to download the data.
:::
