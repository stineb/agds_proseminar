...
- *Session 2 (27.09.)* : Introduction of public datasets and project ideas. Review of AGDS I [Chapter 1](https://geco-bern.github.io/agds/gettingstarted.html).

- *Session 3 (04.10.)* : Introduction to the project proposal structure. [Crash course in R](https://geco-bern.github.io/handfull_of_pixels/basic_R.html) and review of AGDS I [Chapter 7](https://geco-bern.github.io/agds/codemgmt.html). Set up of GitHub repository for project implementation, including a brief exercise.

- *Session 4 (11.10.)* : Short [tutorial](https://geco-bern.github.io/handfull_of_pixels/geospatial_R.html) on raster data. Forming project groups.
