...
- *Session 2 (27.09.)* : Introduction of public datasets and project ideas. Short [tutorial](https://geco-bern.github.io/handfull_of_pixels/geospatial_R.html) on raster data.
...
**Sessions 5-9** - Project implementation in individual group work with questions, answers, and feedback in class.

- *Session 5 (17.10.)* : Presentation slot allocation. Project implementation in individual group work with questions, answers, and feedback in class. 
- *Session 6 (25.10.)* : Project implementation in individual group work with questions, answers, and feedback in class.
- *Session 7 (01.11.)* : Project implementation in individual group work with questions, answers, and feedback in class.
- *Session 8 (08.11.)* : Project implementation in individual group work with questions, answers, and feedback in class.
- *Session 9 (15.11.)* : Project implementation in individual group work with questions, answers, and feedback in class. Groups 1-3 exchange code with each other for feedback.

**Sessions 10-14** - Presentations

- *Session 10 (22.11)* : First half - Project implementation in individual group work with questions, answers, and feedback in class. Groups 4-6 exchange code with each other for feedback. Second half - Presentations of groups 1-3.
...
Project reports and presentations are evaluated. Each pair of students will create a project and submit a GitHub repository, following the [AGDS example project](https://github.com/pepaaran/agds_proseminar_example), with all their code and a R Markdown as part of the report. At the end of the semester, each pair will present their project to the rest of the class and exchange feedback.