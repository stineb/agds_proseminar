...
- *Session 1 (20.09.)* : Course logistics. Introduction of the [example project](https://github.com/pepaaran/agds_proseminar_example). Forming project groups. Checkpoint: R installations and GitHub repository.
